...
O espectro resultante da redução de dados é unidimensional no domínio do comprimento de onda da estrela e tem sua intensidade representada pelo fluxo. O fluxo é capturado em unidades de contagem de fótons, também chamadas de ADUs (\textit{Analog Digital Units}), que são adimensionais. \pc{aqui vai requerer uma explicacao maior, acho que minha provavelmente. o fluxo vem em unidades de contagem de fótons, ou ADUs, que sao adimensionais. Nem sempre o espectro é retificado / normalizado para o intervalo [0,1], os da XSL nao sao por exemplo}O fluxo de um espectro estelar pode ser reescalonado para o intervalo $[0, 1]$, porém nem sempre isto é feito, como pode ser visto na imagem \ref{fig:x0319-obs-spectrum}. 
