...
\thispagestyle{empty}
    ...
    \begin{center}
    Supervisora: Profa. Dra. Paula Rodrigues Teixeira Coelho (IAG)\\
    Co-supervisor: Prof. Dr. Marcelo Gomes de Queiroz 
...
\input 05-cap-conclusoes        % associado ao arquivo: 'cap-conclusoes.tex'
\input 06-cap-perspectivas        % associado ao arquivo: 'cap-conclusoes.tex'
