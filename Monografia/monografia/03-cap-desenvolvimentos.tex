...
\begin{figure}[htb]
  \centering
  \subfloat[Modelo telúrico do Molefit de X0319]{\includegraphics[width=0.5\textwidth]{figuras/x0319_v_o_e_tra.png}}
  \hfill
...
\begin{figure}[H]
  \centering
  \subfloat[Modelo telúrico do Molefit de X0386]{\includegraphics[width=0.5\textwidth]{figuras/x0386_v_n_e_tra.png}}
  \hfill
...
\begin{figure}[H]
  \centering
  \subfloat[Modelo telúrico do Molefit de X0319]{\includegraphics[width=0.5\textwidth]{figuras/x0319_v_o_e_tra_zoom.png}}
  \hfill
...
\begin{figure}[htb]
  ...
  \subfloat[Modelo telúrico do Molefit de X0319]{\includegraphics[width=0.5\textwidth]{figuras/x0319_v_o_e_tra.png}}
  \hfill
  \subfloat[Espectro telúrico ground-truth de X0319]{\includegraphics[width=0.5\textwidth]{figuras/x0319_v_o_e_tra_gt.png}}
...
\begin{figure}[htb]
  ...
  \subfloat[Modelo telúrico do Molefit de X0386]{\includegraphics[width=0.5\textwidth]{figuras/x0386_v_n_e_tra.png}}
  \hfill
  \subfloat[Espectro telúrico ground-truth de X0386]{\includegraphics[width=0.5\textwidth]{figuras/x0386_v_n_e_tra_gt.png}}
...
% mostrar resultados da dtw nas duas estrelas e com zoom
\begin{figure}[htb]
  \centering
  ...
  \hfill
  \subfloat[Espectro telúrico de X0319 reconstruído com caminho do DTW]{\includegraphics[width=0.5\textwidth]{figuras/x0319_v_n_e_tra_dtw.png}}
...
\begin{figure}[H]
  ...
  \hfill
  \subfloat[Espectro telúrico de X0319 reconstruído com caminho do DTW]{\includegraphics[width=0.5\textwidth]{figuras/x0386_v_n_e_tra_dtw.png}}
  \caption{Caminho do DTW e espectro telúrico reconstruído de X0319}
